...
async function startWatching() {
	...
	// watch all governance, deposit, stable, SF, DE, and carburetor AAs
	let base_aas = conf.governance_base_aas.concat([conf.deposit_base_aa]).concat(conf.stable_base_aas).concat(conf.sf_base_aas).concat(conf.de_base_aas).concat([conf.carburetor_base_aa]);
